...
The first `apply_team()` must construct its five Pokemon. This task uses five party slots.
...
The initial call must contain exactly five members in slots 0 through 4. After setup, use the active team returned by `team()` to determine
